...
from . import ks_statistic_for_aapm
...
#----------------------------------------------------------------------------
# Custom metrics (stats-aware-gans)

@register_metric
def ks_stat_aapm_8512(opts):
    opts.dataset_kwargs.update(max_size=None)
    ks_stat = ks_statistic_for_aapm.compute_ks_stat(opts, max_real=8512, num_gen=8512)
    return dict(ks_stat_aapm_8512=ks_stat)
